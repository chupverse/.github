<img src="https://www.chu-poitiers.fr/wp-content/themes/wp-responsive-theme/img/logo-chu-poitiers.png" width="400">

[Inria](https://www.chu-poitiers.fr) is a French University Hospital. It is the only public health establishment in the Vienne department to offer medical, surgical and obstetric care. The *chupverse* reposetory includes R packages for analyses of health data. It also includes examples of calculations of the required sample sizes, presentations proposed in the data science seminars, or LaTex templates.
...
* This repository [slides-of-seminars]([https://github.com/chupverse/survivalSL](https://github.com/chupverse/slides-of-seminars)  contains the slides of the invited speakers.
